...
const enum HtmlUrlReferenceType {
  Single,
  SpaceSeparated,
  SrcSet,
...
type HtmlUrlReference = {
  element: string;
  attribute: string;
  type: HtmlUrlReferenceType;
};

const htmlUrlReferences : HtmlUrlReference[] = [
  {element: 'link', attribute: 'href', type: HtmlUrlReferenceType.Single},
  {element: 'a', attribute: 'href', type: HtmlUrlReferenceType.Single},
  {element: 'area', attribute: 'href', type: HtmlUrlReferenceType.Single},
  {element: 'source', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'img', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'iframe', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'embed', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'video', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'video', attribute: 'poster', type: HtmlUrlReferenceType.Single},
  {element: 'audio', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'track', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'input', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'script', attribute: 'src', type: HtmlUrlReferenceType.Single},
  {element: 'object', attribute: 'data', type: HtmlUrlReferenceType.Single},
  {element: 'form', attribute: 'action', type: HtmlUrlReferenceType.Single},
  {element: 'button', attribute: 'formAction', type: HtmlUrlReferenceType.Single},
  {element: 'blockquote', attribute: 'cite', type: HtmlUrlReferenceType.Single},
  {element: 'ins', attribute: 'cite', type: HtmlUrlReferenceType.Single},
  {element: 'del', attribute: 'cite', type: HtmlUrlReferenceType.Single},
  {element: 'a', attribute: 'ping', type: HtmlUrlReferenceType.SpaceSeparated},
  {element: 'area', attribute: 'ping', type: HtmlUrlReferenceType.SpaceSeparated},
  {element: 'link', attribute: 'imageSrcset', type: HtmlUrlReferenceType.SrcSet},
  {element: 'source', attribute: 'srcset', type: HtmlUrlReferenceType.SrcSet},
  {element: 'img', attribute: 'srcset', type: HtmlUrlReferenceType.SrcSet},

  /* Hack for Piato's weird versioning.js script. */
  {element: 'link', attribute: 'id', type: HtmlUrlReferenceType.SingleNeedsResolving},
  {element: 'script', attribute: 'id', type: HtmlUrlReferenceType.SingleNeedsResolving},
];

type FetchTarget = {
  url: URL;
  path: string;
  original?: FetchTarget;
};
...
function addLink(url: URL, original?: FetchTarget): boolean {
  url.search = '';
  url.hash = '';
...
function scanHtml(url: URL, body: string): URL[] {
  const links = [];
  ...
  for (const {element, attribute, type} of htmlUrlReferences) {
    for (const elt of document.querySelectorAll(`${element}[${attribute}]`)) {
      const value = elt[attribute as keyof typeof elt] as string;
      // console.log(`${element}.${attribute}: ${value}`);
      switch (type) {
        case HtmlUrlReferenceType.Single: {
          links.push(new URL(value));
          break;
        }
        case HtmlUrlReferenceType.SingleNeedsResolving: {
          /* Hack for Piato's weird versioning.js script. */
          links.push(new URL(value, document.baseURI));
          break;
        }
        case HtmlUrlReferenceType.SpaceSeparated: {
          links.push(...value
            .split(/[\t\n\f\r ]+/g)
            .filter(_ => _)
        ...
        case HtmlUrlReferenceType.SrcSet: {
          links.push(...value
            .split(/(?:,[\t\n\f\r ]|[\t\n\f\r ],)/g)
            .map(_ => _.match(/^[\t\n\f\r ]*([^\t\n\f\r ]+)/))
            .filter(_ => _)
...
function scanCss(url: URL, body: string): URL[] {
  const links = [];
  ...
  function parseString(string: string): string | undefined {
...
function scanJavaScript(url: URL, body: string): URL[] {
  const links = [] as URL[];
...
function relativeUrl(baseUrl: URL, url: URL): string | undefined {
  if (url.protocol !== baseUrl.protocol) return;
  if (url.username !== baseUrl.username) return;
  if (url.password !== baseUrl.password) return;
  if (url.hostname !== baseUrl.hostname) return;
  if (url.port !== baseUrl.port) return;
